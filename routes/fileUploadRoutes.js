...
import { uploadFiles, uploadSingleFile, uploadFieldFiles } from "../controller/fileUploadController.js";
...
router.post("/upload-single/:fieldName", authenticateToken, (req, res, next) => {
    const fieldName = req.params.fieldName;
    upload.single(fieldName)(req, res, next);
}, uploadSingleFile);

// Multiple files with specific field names
router.post("/upload-fields", authenticateToken, upload.fields([
